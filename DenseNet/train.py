...
def main():
    ...
    parser.add_argument('--backbone', type=str, default='net121', choices=['net121', 'net161', 'net169', 'net201'],
                                                                           help='backbone name')
    parser.add_argument('--compression', type=float, default=0.7, help='network output stride')
    ...
    parser.add_argument('--workers', type=int, default=12, metavar='N', help='dataloader threads')
    parser.add_argument('--img_size', type=int, default=(200, 200), help='train and val image resize')
